...
function Home() {
  ...
  return (
    <div>
      ...
      <h1>Aiutami A Prenotare</h1>
      <h2>Ti aiutiamo a prenotare un'appuntamento presso il tuo consolato</h2>
      ...
      <button onClick={() => navigate('./Header/index.jsx')}>Richiedi un'appuntamento</button>
    </div>
  );
}
